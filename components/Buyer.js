...
function Buyer() {
  ...
  const handleSubmit = () => {
    fetch(`https://homematcher-rosy.vercel.app/realtys/filteredRealtys?budget[$lt]=${budget}&typeOfRealty=${typeOfRealty}&terrace=${terrace}&livingArea[$lt]=${livingArea}&outdoorArea[$lt]=${outdoorArea}&rooms[$lt]=${rooms}`, {
      method: 'GET',
      headers: {
