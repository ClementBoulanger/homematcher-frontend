...
function Likes() {
    ...
    useEffect(() => {
        fetch('https://homematcher-rosy.vercel.app/notification/messages', {
            method: 'GET',
            headers: {
    ...
    const handleDelete = async (index) => {
        try {
            const response = await fetch(`https://homematcher-rosy.vercel.app/notification/${index}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
    ...
    const handleNotificationClick = (data) => {
        ...
        console.log(userId);
        fetch(`https://homematcher-rosy.vercel.app/users/${userId}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `${user.token}`
    ...
    const handleLick = () => {
        ...
        fetch('https://homematcher-rosy.vercel.app/notification', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `${user.token}`
